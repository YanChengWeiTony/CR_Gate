function  [g, p_g] = fully_Numerical_ActiveCancellation_plot_Import(myx)
%% Spec
...
t_len = 60;
qk_rk_basis_num = 5;
not_optimal_parms = 4; %{phip;B;phac;t_CR}
...
[t, sol] = ode45(@(t, u) odefun(t, u, p, lev), t, [eye(lev^2);zeros([lev^2 * p.tot_basis_num, lev^2])]);
...
for a=1:t_num
    tmp_0 = reshape(sol(a,:), [(1 + p.tot_basis_num)*lev^2,lev^2]);
    tmp_U = tmp_0(1:4, 1:4);
